...
public class UploadFiles extends AppCompatActivity {
    ...
    String url = config.BaseUrl +"uploadfiles.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(UploadFiles.this, UploadFilesListActivity.class);
                startActivity(intent);
            }
        });
        HashMap<String,String>map=new SessionManager(UploadFiles.this).getUserDetails();
        user_id=map.get("id");
    }
...
//                                    sms.sendTextMessage(String.valueOf(spno),null,"Your Application has been submitted successfully.Your Referance Number is  "+otpnew,pi,null);
                                    ...
                                    Toast.makeText(UploadFiles.this, "successfully", Toast.LENGTH_SHORT).show();
                                    Intent intent=new Intent(UploadFiles.this, UploadFilesListActivity.class);
                                    startActivity(intent);
