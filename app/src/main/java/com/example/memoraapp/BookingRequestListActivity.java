...
public class BookingRequestListActivity extends AppCompatActivity {

    String sphn;
    private String url = config.BaseUrl + "bookingrequestlistactivity.php";
    private ArrayList<BookingRequestListModel> dataModelArrayList;
    private BookingRequestListAdapter rvvAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HashMap<String, String> rev = new CaregiverSessionManager(BookingRequestListActivity.this).getUserDetails();
        sphn = rev.get("id");
    ...
    private void setupRecycler() {
        rvvAdapter = new BookingRequestListAdapter(this, dataModelArrayList);
