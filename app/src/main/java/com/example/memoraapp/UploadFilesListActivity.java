...
public class UploadFilesListActivity extends AppCompatActivity {
...
//    MaterialToolbar topAppBar;
    ...
    private String url = config.BaseUrl + "upload_file_list.php";
    private ArrayList<UploadFilesListModel> dataModelArrayList;
    private UploadFilesListAdapter rvvAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_files_list);

        HashMap<String, String> data = new SessionManager(UploadFilesListActivity.this).getUserDetails();
        user_id = data.get("id");
...
//        });
    ...
    private void setupRecycler(){
        rvvAdapter = new UploadFilesListAdapter(this, dataModelArrayList);
